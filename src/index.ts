#!/usr/bin/env bun
/**
 * distributed-lock-manager - Redis-based distributed locks for critical sections
...
program.name("distributed-lock-manager").description("Redis-based distributed locks for critical sections").version("1.0.0")
